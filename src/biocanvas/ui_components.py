...
class PDTabWidgets:
    ...
    def __init__(
        ...
        _default_log_label = next(
            (
                k
                for k, v in logging_config.LOG_LEVEL_MAP.items()
                if v == initial_log_level
            ),
            "INFO",
        )
        ...
        self.progress_bar_output = widgets.Output(
            layout=widgets.Layout(
                width="auto", height="auto", border="0.1px solid gray"
            )
        )
    ...
    def _build_layout(self) -> widgets.AppLayout:
        return widgets.AppLayout(
            ...
            left_sidebar=widgets.VBox(
                [
                    widgets.HTML(
                        "<b>Step 1:</b> Select a project and enter the passcode:"
                    ),
        ...
        return widgets.AppLayout(
            ...
            center=widgets.VBox(
                [
                    ...
                    self.kpi_value_dropdown,
                    widgets.HTML(
                        "<br><b>Step 3:</b> Pick first grouping parameter on X-axis:"
                    ),
                    self.first_grping_param_dropdown,
                    widgets.HTML(
                        "<br><b>Step 4:</b> Pick second grouping parameter (optional):"
                    ),
    ...
    def _build_layout(self) -> widgets.AppLayout:
        return widgets.AppLayout(
            ...
            left_sidebar=widgets.VBox(
                [
                    widgets.HTML(
                        "<b>Step 1: </b> Publish results as a consolidated report:"
                    ),
